          ...
          <div className="feature-cards">
            ...
            <Link to="/pass-play" className="feature-card">
              ...
              <div className="feature-card-content">
                ...
                <h3>Pass & Play</h3>
                <p>Connect with players worldwide or challenge friends locally in real-time matches.</p>
              </div>
            </Link>
          </div>
        </div>
        ...
        <div className="landing-container">
          <div className="cta-content">
            ...
            <p className="cta-description">
              Join thousands of players worldwide and start your chess mastery today.
            </p>
            <button onClick={() => navigate('/signin')} className="primary-btn">
